...
Purpose: This file runs REGROUP and YOLO in real-time on RGB image input (no pre-stored pedestrian detections)
...
Run: python regroup-yolo.py --sequence_dir=../data/test/[sequence]/  --display=1 
'''
...
def gather_sequence_info(sequence_dir):
    ...
    seq_info = {
        ...
        #"d_image_filenames": d_image_filenames,
...
def parse_args():
    ...
    parser.add_argument(
        "--nms_max_overlap",  help="Non-maxima suppression threshold", default=0.5, type=float)
    parser.add_argument(
        "--max_cosine_distance", help="Gating threshold for cosine distance metric (object appearance).", type=float, default=0.2)
    parser.add_argument(
    ...
    parser.add_argument(
        "--img_output_path", help="path to write images",
        default=None)
    parser.add_argument(
...
if __name__ == "__main__":
    ...
    run(
        ...
        args.gp_dist, args.h_ratio, encoder, args.cost_metric, net, layer_names, labels, args.confidence)
