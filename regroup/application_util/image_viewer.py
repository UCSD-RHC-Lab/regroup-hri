...
'''
Filename: image_viewer.py
Purpose: This file group tracking visualization display
...
python show_results.py --sequence_dir=./data/test/<sequence_dir> --result_file=results1.txt --show_false_alarms=True --detection_file=./resources/detections/test_group_multi/group-01.npy --output_file=output_file1.txt --show_false_alarms=True
"""
import numpy as np
import cv2
import time
...
class ImageViewer(object):
    ...
    * 'ESC' : quit
    ...
    def enable_videowriter(self, output_filename, fourcc_string="MJPG",
        ...
        fourcc = cv2.cv.CV_FOURCC(*fourcc_string)
        if fps is None:
